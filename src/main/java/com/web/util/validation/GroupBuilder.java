...
import com.web.util.validation.bean.date.DateOrValidationGroup;
import com.web.util.validation.bean.date.DateValidationGroup;
import com.web.util.validation.bean.number.NumberOrValidationGroup;
import com.web.util.validation.bean.number.NumberValidationGroup;
import com.web.util.validation.bean.string.StringOrValidationGroup;
import com.web.util.validation.bean.string.StringValidationGroup;
