...
public class ExcelUtil {
	...
	static {
		...
		productFieldMap.put("设备厂商", "c");
		productFieldMap.put("前视图", "d");
		productFieldMap.put("后视图", "e");
		productFieldMap.put("U高", "f");
		productFieldMap.put("编号", "g");
		productFieldMap.put("类型", "h");
		productFieldMap.put("方向", "i");
		productFieldMap.put("横坐标", "j");
		productFieldMap.put("纵坐标", "k");
		productFieldMap.put("宽度", "l");
		productFieldMap.put("高度", "m");
		productFieldMap.put("端口类型", "n");
		productFieldMap.put("重量(KG)", "o");
		productFieldMap.put("朝向", "p");
		productFieldMap.put("默认端口", "q");
	 ...
	 *            productFieldMap.put("college.collegeName","学院名称")
	 * @param sheetName
	 *            工作表的名称
	 * @param sheetSize
	 *            每个工作表中记录的最大个数
	...
	public static <T> List<T> excelToList(InputStream in, String sheetName, Class<T> entityClass,
		...
		try {
			...
			if (null != uniqueFields && uniqueFields.length > 0) {
	...
	public static void main(String[] args) throws Exception {
		...
		InputStream is = new FileInputStream("F:\\360安全浏览器下载\\3source_20161106151206179\\IBM System x3850 x5 - 副本\\product.xls");
		String sheetName = "Sheet1";
		String[] uniqueFields = new String[] {};

		List<ProductExcel> list = ExcelUtil.excelToList(is, sheetName, ProductExcel.class, productFieldMap, uniqueFields);
		for (ProductExcel b : list) {
