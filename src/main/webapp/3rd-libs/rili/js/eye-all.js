...
eye.datePicker = function() {
    ...
    var path = getContentPath()+'/3rd-libs/rili/images/cbox/';
    var style = new Array();
    ...
    return {
        ...
        createPicker: function(type) {
            ...
            var selectTop = $(this.obj).offset().top - $("body").scrollTop();

            if (oldDiv != null && oldDiv != undefined) {
                oldDiv.style.top = selectTop + 34 + 'px';
                ...
                newDiv.style.top = selectTop + 34 + 'px';
