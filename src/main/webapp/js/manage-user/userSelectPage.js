		...
		for(var i=0,len=userInfo.length;i<len;i++){
			...
			content = "<tr>"+
				...
				"<td>"+
					...
					"<i style='margin:3px;cursor:pointer' class='fa fa-trash' role=\"presentation\" data-toggle=\"modal\" data-target=\"#userdelete\" data-value=\""+e["id"]+"\" onclick=\"userDeleteInit(this)\"></i>"+
